...
async def send_movie_updates(bot, file_name, caption, file_id):
    try:
        ...
        btn = [[
            InlineKeyboardButton('📂 ɢᴇᴛ ғɪʟᴇ 📂', url=f'https://t.me/+CN1d3qieTNw3ZTY1{temp.U_NAME}?start=getfile-{search_movie}')
        ],[
            InlineKeyboardButton('♻️ ʜᴏᴡ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ ♻️', url=f'https://t.me.newmovies_support')
        ]]
