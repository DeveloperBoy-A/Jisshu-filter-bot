...
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1002192959182'))
request_channel = environ.get('REQUEST_CHANNEL', '-1002192959182') # If anyone sends a request message to your bot, you will get it in this channel.
