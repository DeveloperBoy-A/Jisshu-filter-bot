...
API_HASH = environ.get('API_HASH', '717c9456e6dae1ac7fef32ad0b20f97a750b5b69')
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001672243335 -1002325405552').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
